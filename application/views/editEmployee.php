      			...
      			<div class="settingsContainer ">
					...
					<span class="d-flex pageHead heading-bar">
						<div class="withBackLink">
							...
							<span class="events_title">Edit Profile</span>
						</div>
						...
						<div class="addEmployee-container-child">
							...
							<?php // if(isset($permissions->permissions) ? $permissions->permissions->editEmployeeYN : "N" == "N"){ ?>
								<section class="tab-buttons">
									...
									<span class="nav-button e-s arrow"><span>Personal</span></span>
								...
								<form method="POST" action="<?php echo base_url('settings/updateEmployeeProfile/').$employeeData->users->id;?>" style="height: 100%" enctype="multipart/form-data" onsubmit="return onFormSubmit(event)" id="formSubmit">
									<section class="employee-section editEmpFlex ">	
										...
										<span class="d-flex">											
											...
											<div class="col-md-3">
												<div class="form-floating">
													...
													<label id="fname" class="labels__">First Name<sup><img src="<?php echo base_url('assets/images/icons/star.png'); ?>"></sup></label>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-floating">
									...
									<section class="employee-bank-account-section">
										...
										<div class="parent-child editEmpFlex">
											<?php $eba = $employeeData->employeeBankAccount;
											for($i=0;$i<count($employeeData->employeeBankAccount);$i++){ ?>
												<div class="child">
													...
													<div class="d-flex">
														<div class="col-md-3">
															<div class="form-floating">
																<input placeholder="Account Name" id="account_name" type="text" class="accountName form-control" name="accountName[]" value="<?php echo isset($eba[$i]->accountName) ? $eba[$i]->accountName : ''; ?>">
														...
														<div class="col-md-3">
															<div class="form-floating">
																<input placeholder="Account Number" id="Account_Number" type="text" class="accountNumber form-control" name="accountNumber[]" value="<?php echo isset($eba[$i]->accountNumber) ? $eba[$i]->accountNumber : ''; ?>">
														...
														<?php if($i ==  0){ ?>
															<span class="span-class col-md-3 radioFlex remainder_parent">
											...
											<div class="d-flex">
												<div class="col-md-3">
													<div class="input_box form-floating">
														<input placeholder="Account Name" type="text" class="accountName form-control" name="accountName[]" >	
														<label for="account_name">Account Name</label>
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-floating">
														<input placeholder="Account Number" id="Account_Number" type="text" class="accountNumber form-control" name="accountNumber[]">
														<label for="Account_Number">Account Number</label>
													</div>
												</div>
									...
									<section class="employee-superfund-section">
										...
										<div class="superfund-parent">
											<?php $checkSuperfund = count($employeeData->employeeSuperfunds);
											foreach($employeeData->employeeSuperfunds as $supFund){ ?>
												<div class="superfund-child row">
													<span class="col-md-4">						
														<div class="form-floating">
															<select placeholder="Super Fund Id" id="super_fund_id" class="superFundId form-control" name="superFund[Id][]" value="<?php echo isset($supFund->superFundId) ? $supFund->superFundId : ''; ?>">
															<?php 
															...
															<label for="super_fund_id">Super Fund Id</label>
														</div>
													</span>

													<span class="col-md-4">			
														<div class="form-floating">
															<input placeholder="Super Membership Id" id="super_membership_id" class="superMembershipId form-control" type="text" name="superFund[MembershipId][]" value="<?php echo isset($supFund->superMembershipId) ? $supFund->superMembershipId : ''; ?>">
															<label for="super_membership_id">Super Membership Id</label>
														</div>
													</span>
													<span class="col-md-4">
														<div class="form-floating">
															<input placeholder="Employee Number" class="employeeNumber form-control" id="employee_number" type="text" name="superFund[EmployeeNumber][]" value="<?php echo isset($supFund->employeeNumber) ? $supFund->employeeNumber : ''; ?>">
															<label for="employee_number" class="labels__">Employee Number</label>
														</div>
													</span>
												</div>
											...
											<div class="superfund-child row">
												<span class="col-md-4">
													<div class="form-floating">
														<select placeholder="Super Fund Id" id="super_fund_id" class="superFundId form-control" name="superFund[Id][]">
														<?php 
														$superFundValue = isset($supFund->superFundId) ? $supFund->superFundId : '';
														foreach($superfunds->superfunds as $superfund){
																echo "<option value='$superfund->superFundId'>$superfund->name</option>";
												...
												<span class="col-md-4">
													<div class="form-floating">
														<input placeholder="Super Membership Id" id="super_membership_id" class="superMembershipId form-control" type="text" name="superFund[MembershipId][]" >
														<label for="super_membership_id">Super Membership Id</label>
													</div>
												</span>
												<span class="col-md-4">
													<div class="form-floating">
														<input class="employeeNumber form-control" id="employee_number" type="text" name="superFund[EmployeeNumber][]" >
														<label for="employee_number" class="labels__">Employee Number</label>
													</div>
												</span>
											</div>
								...
								<section class="employee-tax-declaration-section">
									<!-- <h3>Employee Tax Declaration Section</h3> -->
										...
										<div class="form-floating">
											<select placeholder="TFN Exemption Type" id="tfnExemptionType" class="form-control" name="tfnExemptionType" select="<?php echo isset($employeeData->employeeTaxDeclaration->tfnExemptionType) ? $employeeData->employeeTaxDeclaration->tfnExemptionType : ''; ?>">
									...
									<section class="employee-details">
										...
										<div class="d-flex">
											...
											<span class="span-class col-md-4">
												<div class="form-floating">
													<input placeholder="Highest Qualification Certificate" class="form-control" id="highest_qual_cert" name="highest_qual_cert" type="text" value=" ">
										...
										-->		
											<span class="span-class col-md-4">
												<div class="form-floating">
													<input placeholder="Qualification working Toward" class="form-control" id="qual_towards_desc" name="qual_towards_desc" type="text" value="<?php echo isset($employeeData->employeeRecord->qualWorkingTowards) ? $employeeData->employeeRecord->qualWorkingTowards : ''; ?>">
										...
										<!-- 		<span class="span-class col-3">
											...
											<span class="span-class col-md-4">
												<div class="form-floating">
													<input placeholder="Classification" class="form-control" id="classification" name="classification" type="text" value="<?php echo isset($employeeData->employee->classification) ? $employeeData->employee->classification : ''; ?>">
											...
											<span class="span-class col-md-4">
												<div class="form-floating">
													<select placeholder="Ordinary Earning Rate Id" class="form-control" id="ordinaryEarningRateId" name="ordinaryEarningRateId"  class="" type="text" value="<?php echo isset($employeeData->employee->ordinaryEarningRateId) ? $employeeData->employee->ordinaryEarningRateId : ''; ?>">
													</select>
										...
										<!-- 		<span class="span-class col-3">
											...
											<span class="span-class col-md-4">
												<div class="form-floating">
													<input placeholder="Visa type" class="form-control" id="visa_type" name="visa_type" type="text" value="<?php echo isset($employeeData->employeeRecord->visaType) ? $employeeData->employeeRecord->visaType : ''; ?>">
													<label for="visa_type">Visa type</label>
												</div>
											</span>
											<span class="span-class col-md-4">
												<div class="form-floating">
													<input placeholder="Visa Grant Date" class="form-control" id="visa_grant_date" name="visa_grant_date" type="date" value="<?php echo isset($employeeData->employeeRecord->visaGrantDate) ? $employeeData->employeeRecord->visaGrantDate : ''; ?>">
										...
										<div class="courses_div_new ">
											...
											<div class="d-flex">
												...
												<span class="col-md-3 inputfile-box">
													<input placeholder="Certificate" id="certificate" class="certificate form-control inputfile" name="certificate[]" type="FILE">
										...
										<div class="d-flex">
											...
											<?php for($i=0;$i<count($toSize);$i++){ ?>
												...
												<div class="d-flex">
													<span class="span-class col-md-3">
														<div class="form-floating">
															<input  type="text" id="medicalConditions" name="medicalConditions[]" class="medicalConditions form-control" value="<?php echo isset($employeeData->employeeMedicals[$i]->medicalConditions) ? $employeeData->employeeMedicals[$i]->medicalConditions : ''; ?>">
															<label for="medicalConditions">Medical Conditions</label>
														</div>
													</span>
													<span class="span-class col-md-3">
														<div class="form-floating">
															<input  type="text" id="medicalAllergies" name="medicalAllergies[]" class="medicalAllergies form-control" value="<?php echo isset($employeeData->employeeMedicals[$i]->medicalAllergies) ? $employeeData->employeeMedicals[$i]->medicalAllergies : ''; ?>">
															<label for="medicalAllergies">Medical Allergies</label>
														</div>
													</span>						
													<span class="span-class col-md-3">
														<div class="form-floating">
															<input  type="text" id="medication" name="medication[]" class="medication form-control" value="<?php echo isset($employeeData->employeeMedicals[$i]->medication) ? $employeeData->employeeMedicals[$i]->medication : ''; ?>">
															<label for="medication">Medication</label>
														</div>
													</span>
													<span class="span-class col-md-3">
														<div class="form-floating">
															<input  type="text" id="dietaryPreferences" name="dietaryPreferences[]" class="dietaryPreferences form-control" value="<?php echo isset($employeeData->employeeMedicals[$i]->dietaryPreferences) ? $employeeData->employeeMedicals[$i]->dietaryPreferences : ''; ?>">
									...
									<div class="submit-div editEmpSubmit">
										<button id="subm" class="btn btn-deault btn-small btnOrange pull-right">
