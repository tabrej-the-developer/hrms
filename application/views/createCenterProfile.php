				 	...
				 	<span id="centerDetailsYo">
					  ...
					  <div class="input_box">
						...
						<div class="input_box">
							...
							<input class="" type="date" name="center_date_opened" id="centre_date_opened" value="">
						</div>
						<div class="input_box">
							<label>
...
<!-- 						<div class="input_box">
						...
						<div class="input_box">
							...
							<input class="" type="text" name="center_admin_name" id="centre_admin_name" value="">
						</div>
						<div class="input_box">
							<label>
								<i style="color: #aa63ff;" class="fas "></i> Center Nominated Supervisor</label>
							<input class="" type="text" name="centre_nominated_supervisor" id="centre_nominated_supervisor"  value="">
						</div>
					</div>
				<hr>
					<div class="row">
          ...
          <div class="input_box">
		      ...
		      <div class="input_box">
						...
						<input type="number" class="minimum_age" name="minimum_age[]" id="" value="">
					</div>
			    <div class="input_box">
						<label>
