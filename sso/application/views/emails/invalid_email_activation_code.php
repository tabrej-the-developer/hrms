                ...
                <table width="600" cellspacing="0" cellpadding="0" border="0" class="responsive-table">
                    ...
                    <tr>
                        <td align="center" style="font-size:14px;">
                            <h1 style="margin:0;padding:0;">Invalid Activation Code</h1>
                            <small>We provide activation codes from security layer servers, <br>please dont try changing/modifying or any other thing.</small>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
